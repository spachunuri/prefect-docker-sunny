create or replace table {environment}.DQM.ORDERS_HOURLY_SNAPSHOT as
select * from PROD.INFOMART.ORDERS_VW;

create or replace table {environment}.DQM.GEOGRAPHY_HOURLY_SNAPSHOT as
select * from PROD.INFOMART.GEOGRAPHY_VW;

create or replace table {environment}.DQM.ORGANIZATION_HOURLY_SNAPSHOT as
select * from PROD.INFOMART.ORGANIZATION_VW;
